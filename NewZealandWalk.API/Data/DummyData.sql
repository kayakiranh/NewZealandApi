USE [NewZealandWalkDb]
GO
DELETE FROM [NewZealandWalkDb].[dbo].[Regions];
GO
DELETE FROM [NewZealandWalkDb].[dbo].[Difficulties];
GO
DELETE FROM [NewZealandWalkDb].[dbo].[WalkRoutes];
GO
...
GO
INSERT [dbo].[Regions] ([Id], [Code], [Name], [ImageUrl]) VALUES (N'14ceba71-4b51-4777-9b17-46602cf66153', N'BOP', N'Bay Of Plenty', N'https://images.pexels.com/photos/5169056/pexels-photo-5169056.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
GO
INSERT [dbo].[Regions] ([Id], [Code], [Name], [ImageUrl]) VALUES (N'6884f7d7-ad1f-4101-8df3-7a6fa7387d81', N'NTL', N'Northland', N'https://images.pexels.com/photos/5169056/pexels-photo-5169056.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
GO
INSERT [dbo].[Regions] ([Id], [Code], [Name], [ImageUrl]) VALUES (N'f077a22e-4248-4bf6-b564-c7cf4e250263', N'STL', N'Southland', N'https://images.pexels.com/photos/5169056/pexels-photo-5169056.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
GO
...
GO
Insert into [NewZealandWalkDb].[dbo].[WalkRoutes]
(Id, Name, Description, LengthInKm, ImageUrl, DifficultyId, RegionId)
values
